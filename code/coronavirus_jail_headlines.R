...
raw_stories <- read_csv(here::here("data", "coronavirus_jail_headlines.csv"))
...
duplicate_stories <- c(
  1572811745, 1562238399, 1570665251, 1577094250, 1573897646, 1576499637, 
  1555866848, 1562367845, 1557816508, 1553169446, 1553235987, 1557452899, 
  1545473163, 1571732389, 1577496898, 1574636143, 1569062434
)
...
# iwalk(full_texts_html, ~safe_write_xml(.x, file = here::here("data", "coronavirus_jail_full", 
#                                                    str_glue("text_{.y}.xml"))))

full_texts_html <- map(1:nrow(stories_no_dupes), 
                       ~safe_full_text(here::here("data", "coronavirus_jail_full",
                                                  str_glue("text_{.}.xml"))))
...
write_rds(stories_no_dupes, here::here("data", "coronavirus_jail_full.rds"))
write_csv(stories_no_dupes, here::here("data", "coronavirus_jail_full.csv"))
